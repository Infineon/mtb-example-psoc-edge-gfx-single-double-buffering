...
The following example clones the "[Graphics using single and double buffering](https://github.com/Infineon/mtb-example-psoc-edge-gfx-single-double-buffering)" application with the desired name "SingleDoubleBuffering" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-gfx-single-double-buffering --user-app-name SingleDoubleBuffering --target-dir "C:/mtb_projects"
   ```
