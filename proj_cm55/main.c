 ...
 *    2. Performs Single buffering or double buffering operation based on the
...
int main(void)
{
    ...
    if (pdPASS == task_return)
    {
        ...
        printf("****************** "
                "PSOC Edge MCU: Graphics using single and double buffering "
                "****************** \r\n\n");
    ...
    {
        printf("Error: Failed to create cm55_ns_gfx_task.\r\n");
        handle_app_error();
    }
}
